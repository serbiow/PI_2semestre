...
export default function Home() {
    return (
        <main className="bg-[#09172C] transition-transform">
            <header className="text-[E7C7A1] shadow-lg">
                <section className="text-2xl h-auto bg-[#010E21] text-[#E7C7A1] pt-36 py-44 justify-center text-center">
            ...
            <section className="bg-[#09172C] py-20 pt-20 ">
                ...
                <div className="flex flex-wrap gap-16 justify-center">
                    ...
                    <div className="pl-20 pr-20 pt-12 py-16 bg-[#E7C7A1] text-center">
