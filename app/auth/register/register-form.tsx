...
export default function RegisterForm() {
  ...
  return (
    <form className=" p-12 bg-[#E7C7A1] rounded-2xl  " action={dispatch}>
      <h1 className="mb-2 text-2xl font-bold text-black  ">Crie uma conta </h1>
      <p className="mb-10">Preencha os campos com seus dados</p>
      {/*Nome*/}
